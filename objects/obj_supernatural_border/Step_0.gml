...
if j == 0 {
	...
	if global.global_stats.border <= 0 {
		instance_destroy();
		if global.player_stats[0].player_active == 1 { global.player_stats[0].player_score += round(global.global_stats.cherry / 10) * 10 }
		if global.player_stats[1].player_active == 1 { global.player_stats[1].player_score += round(global.global_stats.cherry / 10) * 10 }
