...
button = [];
desc = [];
array_copy(button,0,struct_data.type_select.option_name,0,array_length(struct_data.type_select.option_name));
array_copy(desc,0,struct_data.type_select.option_description,0,array_length(struct_data.type_select.option_description));
