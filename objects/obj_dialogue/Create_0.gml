...
shd[0] = scribble_font_bake_shadow(font_get_name(global.font[1]),"drp_shd",1,1,make_color_rgb(0,0,0),1,0,false);
shd[1] = scribble_font_bake_shadow("font_misaki","drp_shd1",1,1,make_color_rgb(0,0,0),1,0,false);
